// =====================================================================
//  NineBands — çalışma içeriği (tek kaynak)
//  Yeni içerik eklemek için ilgili diziye aynı yapıda madde ekle.
// =====================================================================
...
export const LEVELS: Record<Level, LevelInfo> = {
  B1: {
    ...
    modules: [
      {
        id: "b1m1",
        name: "Modül 1 — Zamanlar (Tenses)",
        focus: "Present / Past / Future temelleri",
        tasks: [
          "Grammar: Present Simple vs Continuous konusunu bitir",
          "Grammar: Past Simple vs Present Perfect konusunu bitir",
      ...
      {
        id: "b1m5",
        name: "Modül 5 — B1 → B2 köprüsü",
        focus: "Passive, kısa essay",
        tasks: [
          "Grammar: Passive voice (temel) konusunu bitir",
          "120-150 kelimelik fikir paragrafı yaz (Yazma sekmesi)",
          "Claude'a B1 seviye testi yaptır: 20 soruluk grammar+kelime",
          "Sonuç iyiyse B2 seviyesine geç 🎉",
        ],
      },
    ],
  },
  B2: {
    ...
    modules: [
      {
        id: "b2m1",
        name: "Modül 1 — Format & Listening",
        focus: "Sınav yapısı + dinleme soru tipleri",
        tasks: [
          ...
          "Yazma: ilk Task 2 essay'ini yaz + Claude'a puanlat",
        ],
      },
      {
        id: "b2m2",
        name: "Modül 2 — Reading teknikleri",
        ...
        tasks: [
          ...
          "Yazma: 1 essay (Opinion tipi)",
        ],
      },
      {
        id: "b2m3",
        name: "Modül 3 — Writing Task 1",
        focus: "Grafik/tablo betimleme",
        tasks: [
          ...
          "Yazma: 1 essay (Discussion tipi)",
        ],
      },
      {
        id: "b2m4",
        name: "Modül 4 — Writing Task 2 + Speaking",
        focus: "Essay yapısı + akıcılık",
        tasks: [
          ...
          "Yazma: bu hafta her gün 1 essay",
        ],
      },
      {
        id: "b2m5",
        name: "Modül 5 — Ara deneme",
        focus: "İlk testle karşılaştır",
        tasks: [
          ...
          "7.0+ alıyorsan C1 seviyesine geç",
        ],
      },
    ],
  },
  C1: {
    ...
    modules: [
      {
        id: "c1m1",
        name: "Modül 1 — Hız & doğruluk",
        focus: "Zamanlı tam testler",
        tasks: [
          ...
          "Yazma: her gün 1 Task 2, band 8 hedefiyle",
        ],
      },
      {
        id: "c1m2",
        name: "Modül 2 — Yüksek band Writing",
        ...
        tasks: [
          ...
          "Yazma: her gün 1 essay",
        ],
      },
      {
        id: "c1m3",
        name: "Modül 3 — Speaking 8+",
        focus: "Akıcılık + idiomatik dil",
        tasks: [
      ...
      {
        id: "c1m4",
        name: "Modül 4 — Tam mock sınavlar",
        focus: "Gerçek sınav simülasyonu",
        tasks: [
...
export const ROUTINES: Record<Level, string[]> = {
  ...
  B2: [
    ...
    "Yazma: 1 essay yaz + Claude'a puanlat (45 dk)",
  ...
  C1: [
    ...
    "Yazma: 1 essay (Task 2) — band 8+ hedefiyle, Claude'a puanlat (50 dk)",
...
export const GRAMMAR: GrammarLesson[] = [
  {
    ...
    examples: [
      "I usually drink tea. (alışkanlık)",
      "I am drinking coffee now. (şu an)",
      "She works at a bank.",
      "They are studying for IELTS this month. (geçici)",
    ],
  ...
  },
  {
    ...
    points: [
      "Zaman: at (saat: at 5), on (gün: on Monday), in (ay/yıl: in May, in 2026).",
  ...
  },
  {
    id: "g_complex",
    level: "C1",
    title: "İleri Cümle Yapıları (band 8+)",
    ...
    points: [
      ...
      "Nominalisation: 'The increase in pollution...' ('Pollution increased' yerine).",
    ],
    examples: [
...
export const VOCAB: Record<string, VocabCard[]> = {
  ...
  "AWL Sublist 1": [
    ...
    { w: "derive", d: "türetmek (from)", e: "The word derives from Latin." },
...
export const LISTENING: ListeningTask[] = [
  {
    ...
    after: [
      "Transkripti aç, kaçırdığın yerleri işaretle.",
      "5 kelimeyi Kelime sekmesine ekle (Claude'a örnek cümle yaptır).",
      "Claude'a yaz: 'Bu konuyu 4-5 cümleyle özetledim, kontrol et: ...'",
    ],
  },
  {
    id: "l_b1_2",
  ...
  },
  {
    id: "l_b2_1",
    level: "B2",
    title: "TED Talk + not alma",
    topic: "Akademik fikirler",
    mins: 12,
    source: "TED",
    url: "https://www.ted.com/talks",
    before: ["10-15 dakikalık, ilgi alanına yakın bir TED Talk seç.", "Altyazıyı KAPAT (önce desteksiz dene)."],
    during: ["Konuşmacının ana argümanını ve 3 destekleyici noktayı not al (IELTS notes mantığı)."],
    after: [
      "Altyazıyı açıp ikinci kez dinle, kaçırdıklarını tamamla.",
      "Shadowing: 2 dakikalık bir bölümü konuşmacıyla birlikte tekrarla.",
      "Claude'a yaz: 'Bu konuşmanın ana fikrini özetledim, akademik dilimi düzelt: ...'",
    ],
  },
  {
    id: "l_b2_2",
    level: "B2",
    title: "IELTS Listening — resmi örnek",
    topic: "Sınav formatı",
    mins: 30,
    ...
    after: [
      "Cevap anahtarıyla puanla, band'ini hesapla.",
      "Her hatayı 'neden kaçırdım' notuyla hata defterine yaz (kelime mi, hız mı, yazım mı?).",
    ],
  },
  {
    id: "l_c1_1",
    level: "C1",
    title: "Akademik ders / lecture dinleme",
    topic: "İleri akademik",
    mins: 20,
    source: "TED-Ed / üniversite dersleri",
    ...
    after: [
      "Notlarından bakmadan 150 kelimelik bir özet yaz.",
      "Claude'a yaz: 'Bu dersi dinleyip özetledim. Akademik kelime ve cohesion açısından band 8 seviyesine çek: ...'",
    ],
  },
  {
    id: "l_c1_2",
    level: "C1",
    title: "Podcast — hızlı/doğal konuşma",
    topic: "Aksan & akıcılık",
    mins: 30,
    ...
    after: [
      "Bir bölümü tekrar dinleyip bilmediğin idiom/collocation'ları çıkar.",
      "C1 'İleri & Collocation' kelime listene ekle.",
      "Claude'a yaz: 'Bu ifadeleri dinledim, anlamlarını ve örnek kullanımlarını ver: ...'",
    ],
  },
];
...
export const RESOURCES: ResourceGroup[] = [
  ...
  },
  {
    ...
    items: [
      { name: "Claude ile pratik", url: "https://claude.ai", desc: "Cue card al, cevap ver, anında band + düzeltme" },
